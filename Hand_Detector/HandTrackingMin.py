...
while True:
    ...
    results = hands.process(imgRGB)  # this will get the handmarks for the hands


    # Drawing Hands
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            for id, lm in enumerate(handLms.landmark): # Getting the landmarks of each point in hand
                # print(id, lm)
                h, w, c = img.shape
